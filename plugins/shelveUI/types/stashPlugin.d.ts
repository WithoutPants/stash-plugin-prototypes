...
interface IPluginApi {
  ...
  GQL: {
    ...
    useFindScenesQuery(args: { skip?: boolean, variables: QueryFindScenesArgs }): {
...
interface StashPluginComponents {
  ...
  FolderSelect: (props: any) => React.JSX.Element;
  Pagination: (props: any) => React.JSX.Element; // TODO fix in stash
  Setting: (props: ISetting) => React.JSX.Element;
}
...
interface PatchableComponentsBefore {
  ...
  (
    component: "SettingsToolsSection",
    fn: (props: any) => { children: React.JSX.Element; }[]
  ): void;
}
